    ...
    <section class="vtuber-logo">
        <div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center;">
            ...
            <div style="text-align: center; margin: 10px;">
                <img width="710px" height="auto" src="/img/banner-small.webp" srcset="/img/banner-small.webp 1x, /img/banner.webp 2x" style="margin: 10px;" loading="lazy" alt="Banner; Art by Rafa" title="Banner; Art by Rafa" />
